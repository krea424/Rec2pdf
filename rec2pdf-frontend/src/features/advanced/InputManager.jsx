...
const InputManager = ({
  ...
  const parametersCard = classNames(
    "rounded-2xl border p-4 transition-all",
    isBoardroom ? boardroomSecondarySurface : themes[theme].input
  );

  const profileSelectId = "advanced-profile-select";
  const destDirInputId = "advanced-dest-dir";
  const slugInputId = "advanced-slug";
  const workspaceSelectId = "advanced-workspace";
  const projectSelectId = "advanced-project";
  const statusSelectId = "advanced-status";
  ...
  return (
    ...
    >
      <section className={parametersCard}>
        ...
        {workspaceProfileLocked && activeWorkspaceProfile && (
          <div className={classNames(
            ...
            isBoardroom ? boardroomChipSurface : "border-emerald-500/40 bg-emerald-500/10 text-emerald-100"
          )}>
      ...
      <section className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div className={parametersCard}>
          ...
          {context.showDestDetails && (
            ...
            >
              {context.destIsPlaceholder
                ? `Completa il percorso partendo da "${context.DEFAULT_DEST_DIR}" con il tuo username e la cartella finale.`
        ...
        <div className={parametersCard}>
          <label
            ...
            htmlFor={slugInputId}
          >
            <FileText className="h-4 w-4" /> Slug file
          </label>
          <input
            id={slugInputId}
            className={classNames(
      ...
      <section className={parametersCard}>
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            <div>
              <label className="text-xs text-zinc-500" htmlFor={workspaceSelectId}>
                Workspace
              </label>
              <select
          ...
          {context.workspaceSelection.workspaceId && (
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              <div>
                <label className="text-xs text-zinc-500" htmlFor={projectSelectId}>
                  Progetto
                </label>
                <select
                  id={projectSelectId}
              ...
              <div>
                <label className="text-xs text-zinc-500" htmlFor={statusSelectId}>
                  Stato
                </label>
                <select
                  id={statusSelectId}
      ...
      <section id="prompt-library" className={parametersCard}>
        <PromptLibrary
