...
// ===== Configurazione Path (Versione Finale per Monorepo Docker) =====
...
const ASSETS_DIR = process.env.ASSETS_DIR || path.join(PROJECT_ROOT, 'assets');

console.log('📁 Percorsi backend configurati (Versione Monorepo Docker):');
